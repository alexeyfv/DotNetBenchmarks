...
/// <summary>
/// https://github.com/ogxd/gxhash-csharp/blob/main/GxHash/GxHash.cs
/// </summary>
public class GxHash
{
    ...
    private static unsafe bool IsReadBeyondSafe(ref Vector128<byte> reference)
    {
        ...
        nint address = (nint)Unsafe.AsPointer(ref reference);
        nint offsetWithinPage = address & PAGE_SIZE - 1;
